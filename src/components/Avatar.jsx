export function Avatar({handleUploadImage, handleChangeImage, handleRemoveImage, avatar}) {
  ...
  return (
    <div className="w-xs">
      <h3 className="text-xl opacity-80 my-2">Upload Avatar</h3>
     
      <label id="avatarInput1" htmlFor="inputFile" className=
        "flex flex-col items-center justify-center outline outline-dashed my-2 h-32 outline-amber-50/60 rounded-xl w-full p-3 bg-blue-100/5 backdrop-blur-lg">
      ...
      <div id="infoAvatar">
        <img src="assets\images\icon-info.svg" alt="info" className="inline px-2"/>
        <p className="inline text-[10px] opacity-70">Upload your photo (JPG or PNG, max size: 500KB).</p>
      </div>
      
      <div id="errAvatar1" className="hidden">
        <img src="assets\images\icon-info.svg" alt="info" className="inline px-2 "/>
        <span className="text-red-400! text-[10px]">Please upload a photo.</span>
      </div>
